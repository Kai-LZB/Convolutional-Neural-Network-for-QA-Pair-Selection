...
class SentenceDataStream(object):
    ...
    def _prepare_HITNLP_data(self, qa_file_path):
        ...
        for l in f:
            ...
            if self.t_e_mode == 't':
                self.instances.append((q_idx_seq, a_idx_seq, label))
            else:
                self.instances.append((q_idx_seq, a_idx_seq)) # in evaluation mode results are generated by model and saved later
